export const Storage = {
    ...
    defaultData: {
        students: [
            { id: '1', name: 'John Doe', grade: 'GRADE 1', admissionNo: '2024/001', assessmentNo: 'ASN-001', upiNo: 'UPI-789X', stream: 'North', parentsContact: '0711222333', selectedFees: ['t1', 't2', 't3', 'bookFund', 'caution', 'studentCard'] },
            { id: '2', name: 'Jane Smith', grade: 'GRADE 2', admissionNo: '2024/002', assessmentNo: 'ASN-002', upiNo: 'UPI-456Y', stream: 'South', parentsContact: '0722333444', selectedFees: ['t1', 't2', 't3', 'breakfast', 'lunch'] }
        ],
        assessments: [
    ...
    getGradeInfo(score) {
        ...
        return { level: 'BE2', points: 1, label: 'Below Expectations', desc: 'Minimal' };
    },
